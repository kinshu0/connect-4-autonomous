...
public class ConnectFour {
	...
	public static void playSingleGame(){
		...
		ConnectFourPlayer player1 = new ConnectFourAIPlayerOther(m, 2, 10);
		ConnectFourPlayer player2 = new ConnectFourAIPlayer(m, 2, 10);
	...
	public static void playBatchGames(int plays){
		...
		for(int i=0; i<plays; i++){
			try{
				...
				// ConnectFourPlayer player2 = new ConnectFourRandomPlayer(m);
				ConnectFourPlayer player1 = new ConnectFourAIPlayer(m, 5);
				ConnectFourPlayer player2 = new ConnectFourAIPlayerOther(m, 5);
